...
<div class="sidenav-overlay"></div>
    ...
    <script src="{{URL::asset('admin/app-assets/vendors/js/charts/chartist.min.js')}}"></script>
    <script src="{{URL::asset('admin/app-assets/vendors/js/charts/chartist-plugin-tooltip.min.js')}}"></script>
