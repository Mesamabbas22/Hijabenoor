                    ...
                    <div class="row">
                        <div class="col-sm-4 col-12">
                            <div class="product-img d-flex align-items-center">
                                ...
                                <img alt="Card image cap" class="img-fluid mb-1" src="{{URL::asset('admin/app-assets/images/elements/fitbit-watch.png')}}">
                            </div>
                        </div>
                        ...
                        <div class="product-content tab-content px-1 pt-1">
                            ...
                            <div aria-labelledby="review" class="tab-pane" id="ratings">
                                ...
                                <div class="media-list media-bordered">
                                    ...
                                    <div class="media">
                                        <span class="media-left">
                                            <img alt="Generic placeholder image" class="media-object" src="{{URL::asset('admin/app-assets/images/portrait/small/avatar-s-8.png')}}" width="64" height="64" />
                                        </span>
                                        <div class="media-body">
                                            <span class="ratings float-right">
                                            </span>
                                    ...
                                    <div class="media">
                                        <span class="media-left">
                                            <img alt="Generic placeholder image" class="media-object" src="{{URL::asset('admin/app-assets/images/portrait/small/avatar-s-6.png')}}" width="64" height="64" />
                                        </span>
                                        <div class="media-body">
                                            <span class="ratings float-right">
                                            </span>
                            ...
                            <div aria-labelledby="comments" class="tab-pane" id="comment">
                                ...
                                <div class="media-list media-bordered">
                                    <div class="media">
                                        <span class="media-left">
                                            <img alt="Generic placeholder image" class="media-object" src="{{URL::asset('admin/app-assets/images/portrait/small/avatar-s-10.png')}}" width="64" height="64" />
                                        </span>
                                        <div class="media-body">
                                            <h5 class="media-heading mb-0 text-bold-600">
                                                Fruitcake apple pie
                                    ...
                                    <div class="media">
                                        <span class="media-left">
                                            <img alt="Generic placeholder image" class="media-object" src="{{URL::asset('admin/app-assets/images/portrait/small/avatar-s-12.png')}}" width="64" height="64" />
                                        </span>
                                        <div class="media-body">
                                            <h5 class="media-heading mb-0 text-bold-600">
                                                Tiramisu cupcake
                                    ...
                                    <div class="media">
                                        <span class="media-left">
                                            <img alt="Generic placeholder image" class="media-object" src="{{URL::asset('admin/app-assets/images/portrait/small/avatar-s-7.png')}}" width="64" height="64" />
                                        </span>
                                        <div class="media-body">
                                            <h5 class="media-heading mb-0 text-bold-600">
